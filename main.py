...
Membros da Equipe:
- Nick D: Implementou UC01 - Criar e Salvar Simulação
- Nick C: Implementou UC02 - Editar Simulação  
- Nick J: Implementou UC03 - Testar/Calcular Simulação
...
# ============================================================================
# UC01 - CRIAR E SALVAR SIMULAÇÃO (IMPLEMENTADO POR Nick D)
# ============================================================================

class GerenciadorSimulacao:
    """
    Responsável por criar novas simulações e salvar em arquivo
    ...
    def salvar_simulacao(self, id_simulacao: str, caminho_arquivo: str) -> tuple[bool, str]:
        """
        UC01 - Salva simulação em arquivo JSON
    ...
    def carregar_simulacao(self, caminho_arquivo: str) -> tuple[bool, str]:
        ...
        try:
            ...
            print(f"[UC01] Simulação carregada: {simulacao.id} - {simulacao.nome} - Nick D")
...
# ============================================================================
# UC02 - EDITAR SIMULAÇÃO (IMPLEMENTADO POR Nick C)
# ============================================================================

class EditorSimulacao:
    """
    Responsável por editar parâmetros das simulações existentes
    ...
    def editar_parametros(self, id_simulacao: str, **novos_parametros) -> tuple[bool, List[str]]:
        """
        UC02 - Edita os parâmetros de uma simulação existente
        
        Args:
            id_simulacao: ID da simulação a editar
        ...
        print(f"[UC02] Editando simulação: {simulacao.nome} - Nick C")
        ...
        if valida:
            print(f"[UC02] Parâmetros editados com sucesso - Nick C:")
            for param in parametros_alterados:
                print(f"[UC02]   - {param}")
            return True, []
        else:
            print(f"[UC02] Erros na validação após edição:")
            for erro in erros:
                print(f"[UC02]   - {erro}")
            return False, erros
...
# ============================================================================
# UC03 - TESTAR/CALCULAR SIMULAÇÃO (IMPLEMENTADO POR Nick J)
# ============================================================================

class CalculadoraSimulacao:
    """
    Responsável por calcular e testar simulações de investimento
    ...
    def _calcular_projecao_mensal(self, simulacao: Simulacao) -> List[ResultadoMensal]:
        ...
        print(f"[UC03] Calculando {simulacao.prazo_meses} meses... - Nick J")
    ...
    def testar_simulacao(self, id_simulacao: str) -> Dict[str, Any]:
        """
        UC03 - Testa a simulação e retorna resumo dos resultados
        ...
        """
        print(f"[UC03] Testando simulação {id_simulacao} - Nick J")
        ...
        print(f"[UC03] Teste concluído - Saldo final: R$ {ultimo_resultado.saldo_final:,.2f} - Nick J")
        
        return resumo
    
    def obter_evolucao_mensal(self, id_simulacao: str) -> Optional[List[Dict[str, Any]]]:
        """
        UC03 - Obtém evolução mês a mês para análise
...
class SistemaSimulacaoInvestimentos:
    ...
    def __init__(self):
        ...
        print("  UC01 - Criar e Salvar Simulação (Nick D)")
        print("  UC02 - Editar Simulação (Nick C)")
        print("  UC03 - Testar/Calcular Simulação (Nick J)")
